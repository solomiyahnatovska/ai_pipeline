...
java -Dlog.level=DEBUG -Dconfig.file=cromwell.conf -jar ../cromwell/cromwell-88.jar run ../gatk4-germline-snps-indels/haplotypecaller-gvcf-gatk4.wdl --inputs  ../gatk4-germline-snps-indels/haplotypecaller-gvcf-gatk4.hg38.wgs.inputs.json \
